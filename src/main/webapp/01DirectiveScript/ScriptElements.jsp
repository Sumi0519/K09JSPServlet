...
<%
	//자바에서는 메서드를 만들기위해서는 클래스가 필요하다.
	//해당 메서드는 static이므로 객체 생성없이 호출할 수 있다.
	int sum = MyClass.myFunc(1,100);
	out.println("1~100까지의 합:"+ sum); //웹브라우저
	System.out.println("1~100까지의 합:"+ sum); //콘솔
%>
</body>
</html>
