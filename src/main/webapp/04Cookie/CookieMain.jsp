...
<%
/*
쿠키는 생성자를 통해서만 생성할 수있다. setName()이란 메서드가 없으므로
...
//여기까지의 코드를 통해 클라이언트 측에 쿠키가 생서된다.
%>
...
//가져온 쿠키가 있다면 갯수만큼 반복한다.(null이 아닐때)
if(cookies != null) {
...
/*
쿠키가 생성된 직후에는 쿠키값을 읽을 수 없다. 새로고침(F5) 하거나 페이지 이동을 통해
